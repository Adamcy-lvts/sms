...
// use App\Models\{Admission, Student, School, Staff}; // Import models we want to use

// class TemplateVariableCreator
// {
//     /**
//      * Get all models and their fields that can be used for variables
//      * This is like a registry of all data sources we can use
//      */
...
//     /**
//      * Get all database columns from a model and format them nicely
//      */
...
//                 // Try different relationship name formats
//                 $relationName = str_replace('_id', '', $column);
//                 $camelCase = Str::camel($relationName); // classRoom

//                 // Check both snake_case and camelCase relationship methods
//                 if (method_exists($model, $relationName) || method_exists($model, $camelCase)) {
//                     $actualRelation = method_exists($model, $camelCase) ? $camelCase : $relationName;

//                     $fields[$relationName . '_name'] = [
//                         'name' => $relationName . '_name',
//                         'label' => Str::title(str_replace('_', ' ', $relationName)) . ' Name',
//                         'type' => 'relation',
